package com.itlsr.run;

import com.itlsr.bean.Business;
import com.itlsr.bean.Customer;
import com.itlsr.bean.Movie;
import com.itlsr.bean.User;
        ...
        while (true) {
            ...
            switch (command){
                ...
                case "4":
                    ...
                    break;
                case "5":
                    System.out.println(loginUser.getUserName() +"欢迎您下次光临！！！");
                    return; // 干掉方法
                default:
            ...
            if(movie != null){
                ...
                while (true) {
                    try {
                        ...
                        movie.setPrice(Double.valueOf(price));//Double.valueOf(price)将价格转为Double类型
